...
def __init_process(*args):
    ...
    vocab, syn0_tmp, syn1_tmp, table, cbow, neg, dim, starting_alpha, win, num_processes, character_rate, global_word_count = args[
                                                                                                                                              :-1]
...
def train(fi, fo, cbow, neg, dim, alpha, win, min_count, num_processes, binary, character_rate):
    ...
    # Init net
    syn0, syn1 = init_net(dim, len(vocab), character_size)
...
if __name__ == '__main__':
    ...
    output_file = "/Users/LeonTao/PycharmProjects/deborausujono/word2vecpy/data/people's_daily_word_tfidf_skip_grim_100d"
