...
def load_matrix(f_path):
    with codecs.open(f_path, errors='ignore') as f:
        row, col, data, iw = [], [], [], []
        first_line = True
        lines_num = 0
        for line in f:
...
def main(vectors_path, analogy_path):
    neg = 1
    results = {}
...
if __name__ == '__main__':
    vectors_path = "/Users/LeonTao/PycharmProjects/deborausujono/word2vecpy/data/people's_daily_character_word_tfidf_cbow_100d"
    analogy_path = "./data/morphological.txt"
    main(vectors_path, analogy_path)
