...
class Analogy(object):
    ...
    def closest_analogies(self, left2, left1, right2, words):
        ...
        left1_vec, left2_vec, right2_vec = self.vector_dict[word_left1], self.vector_dict[word_left2], self.vector_dict[
            word_right2]
...
if __name__ == "__main__":
    ...
    vector_file = "/Users/LeonTao/PycharmProjects/deborausujono/word2vecpy/data/people's_daily_cbow_200d"
